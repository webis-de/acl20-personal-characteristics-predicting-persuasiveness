"""generate csv: similarities of pairs (word2vec vectors of author categories)"""
...
def analyze(sc, **kwargs):
    ...
    wv = pickle.load(open('/home/username/data/word2vec/ae_wvectors_avg', 'rb'))
    ...
    with open(local_output_root + '/entity_w2v_avg.csv', 'w') as out:
...
def process_pair(pair, wv):
    ...
    cos_sim = cosine_similarity(sub_vector.reshape(1,-1), com_vector.reshape(1,-1))
